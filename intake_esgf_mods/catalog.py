...
class ESGFCatalog:
    ...
    #added new function by LeoBertini (just retrieve infos from catalogue search but DO NOT initiate download)
    def infos_to_dict(
        self,
        prefer_streaming: bool = False,
        globus_endpoint: str | None = None,
        ...
        """
        Return the current search as a dictionary of urls and paths to files.
    ...
    def to_dataset_dict(
        ...
        minimal_keys: bool
            Disable to return a dictionary whose keys are formed using all facets in the
            master_id.
        ignore_facets: str or list of str
            When constructing the dictionary keys, which facets should we ignore?
        separator: str
